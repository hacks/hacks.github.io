<template>
  <div class="hacks-github-corner">
    ...
    <div v-else>
      <a :href="link" class="github-corner" target="_blank" aria-label="View source on GitHub">
        <svg
          width="80"
          height="80"
          viewBox="0 0 250 250"
...
export default {
  ...
  props: {
    /**
     * Determines which side the corner should be on.
     *
     * @type {Boolean}
     * @required true
     * @default true
    ...
    /**
     * The page the GitHub Corner leads to.
     *
     * @type {String}
     * @required true
     * @default null
